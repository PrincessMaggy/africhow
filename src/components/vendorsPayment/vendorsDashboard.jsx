           ...
           <Layout>
            <div className='sm:px-8 px-4'>
                    <div className='text-start sm:p-10 p-4 bg-[#145062]'>
                        <div className=''>
                            <p className='text-white sm:text-sm text-xs sm:font-light font-extralight'>
                                Total Earnings
                            </p>
                            <p className='sm:my-4 my-2 text-white sm:text-2xl text-xl font-semibold '>
                                $ 82,570.00
                            </p>
                        </div>
                        <div>
                            <Link to='/vendors-payout-method'>
                                <button className='rounded text-sm p-2 bg-[#33CC9F]'>
                                    Payout method
                                </button>
                            </Link>
                            <Link to='/vendors-transaction'>
                                <button className='rounded text-sm p-2 sm:m-6 sm:ms-4 ms-2 bg-white'>
                                    Transactions
                                </button>
                            </Link>
                        </div>
                            ...
                            <div>
                                {firstthreeData.map((item) => (
                                    <div
                                        key={item.id}
                                        role='list'
                                        className='flex justify-between sm:pt-6 sm:pb-4 pt-4 pb-2 border-b border-[#EAEAEA]'
                                    >
                                        <div className='flex'>
                                            <img
                                                className='h-10 w-10 rounded-full'
                                                src={item.image}
                                                alt={item.payouttitle}
                                            />
                                            <div className='sm:ml-4 ml-3 '>
                                                <p className='md:text-lg text-sm sm:text-lg font-medium text-start text-slate-900'>
                                                    {item.payouttitle}
                                                </p>
                                                <p className='md:text-base text-sm text-start text-slate-500'>
                                                    {item.date}
                                                </p>
                                            </div>
                                        </div>
                                        <div className='flex justify-center items-center'>
                                            <p className='md:text-lg text-sm font-medium text-slate-900 text-start'>
                                                {item.amount}
                                            </p>
                                        </div>
                                    </div>
