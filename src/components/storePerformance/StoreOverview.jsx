    ...
    <section className="font-manrope mx-10">
      ...
      <section className="flex items-center justify-between gap-30 bg-secondary text-white text-center lg:pt-2 lg:px-8 pt-2 px-2">
        ...
        <section className="flex ">
          <h2>
            <span className="lg:text-2xl text-xs font-bold">Complete KYC</span>
            <br></br>{" "}
        ...
        {/* Overview section */}
      <h2 className="text-start mt-10 lg:text-2xl text-lg font-semibold">
        Overview
      </h2>
      ...
      <section className="grid lg:grid-cols-2 grid-cols-2 lg:gap-6 gap-2">
        <div className="border lg:pt-10 pt-4 lg:pb-10 pb-4 p-5 mt-8 bg-light-green">
          ...
          <h3 className="text-start lg:text-4xl text-xl font-semibold">0</h3>
        </div>
        ...
        <div className="border lg:pt-10 pt-4 lg:pb-10 pb-4 p-5 bg-light-green">
          ...
          <h3 className="text-start lg:text-4xl text-xl font-semibold">-</h3>
        </div>
      </section>
