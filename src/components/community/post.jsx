...
<form>
        <div className="max-w-full  border border-gray-200 px-4 m-8 rounded-lg bg-green-50 dark:bg-gray-700 dark:border-gray-600">
          <div className="px-4 py-2 bg-white rounded-t-lg dark:bg-gray-800">
            ...
            <textarea id="comment" rows={3} className="w-full  text-sm h-96 text-gray-900 bg-white border-0 dark:bg-gray-800 focus:ring-0 dark:text-white dark:placeholder-gray-400" placeholder="What do you want to talk about..." required defaultValue={""} />
          </div>
