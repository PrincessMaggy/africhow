...
const RecipesPage = ({ searchQuery }) => {
    ...
    const recipes = [
      ...
      {
        id: 1,
        image: <img src={Foodzone} alt="image of food" className="block h-auto w-full"/>,
  ...
  const handleSearchInputChange = (event) => {
    ...
    return (
        ...
        {filteredRecipes.map((recipe) => (
             <div key={1}>
    <div className="my-1 px-5  w-full border border-gray-400  bg-[#f1f1f1]" id="1">
...
<div className="overflow-hidden rounded-lg shadow-lg">
    ...
    <div className=" flex  mb-2 md:p-4">
       ...
       <div className="max-[390px]:text-left lg:text-center mt-4">
            <h1 className="font-bold pt-4">Discussion</h1>
           </div>
