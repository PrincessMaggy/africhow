    ...
    <div>
      ...
      <div id="ofada">
        ...
        <div className="text-left m-8">
          ...
          <p className="text-sm">
            Add palm oil into a sauce pan and heat up for a while, then add
            onions and locust beans. Simmer for about 5 minutes. then add Dried
            fish and chopped cow skin. Add your pepper mix and salt and fry the
            mixture till the oil separates on the surface of the sauce and that
            is all. in a separate pot, boil your rice till it is soft but not
            over cooked and your ofada is ready.
          </p>
        </div>
      </div>
      ...
      <div className="comment">
        ...
        <article id="comment">
          <div>
            ...
            <p className="mt-4 ml-8 dark:text-gray-400 text-left">
              I can’t wait to try out this recipe. it will definitely bring a
              feel of Africa in to my home. But where can I get some of this
              ingredients?.
            </p>
          </div>
          <div>
            ...
            <p className="mt-4 ml-8 text-left dark:text-gray-400">
              This bring back beautiful memories of Sunday afternoons back home.
              Even though, I dont like rice, my mom makes ofada in a way that is
              irresistible.
            </p>
          </div>
          <div>
            <div className="flex bg-gray-50 border  border-green-500 m-4 lg:justify-center lg:mb-1">
              <img
                src={Male}
                alt=""
                className="w-10 h-10 rounded-full mt-3 dark:bg-gray-500"
              />
              <input
                type="text"
                className="bg-gray-300 p-3  border  outline-none text-center"
              />
              <img
                src={Send}
                alt=""
                className="w-10 h-10 m-2 rounded-full mt-3 dark:bg-gray-500"
              />
            </div>
          </div>
        </article>
        ...
        <article>
          <div>
            <h1 className="font-bold text-[#155062] text-left pt-4 ml-8 lg:text-center">
              Read Articles
            </h1>
            <div className="flex  mt-8  ml-8">
              <img
                src={Chicken}
                alt="chicken"
                className="w-10 h-10 rounded dark:bg-gray-500"
              />
              <div className="flex relative justify-between">
                <div className="ml-2 min-w-48">
                  <h1 className="font-semibold text-black-300">
                    Taste of Home
                  </h1>
                  <p className="text-sm text-gray-300">
                    Regional Recipes and Flavors
                  </p>
                </div>
            ...
            <div className="flex  mt-8 ml-8  ">
              ...
              <div className="flex  relative justify-between">
                <div className="ml-2 min-w-48">
                  ...
                  <p className="text-sm text-gray-300 ">
                    Culinary Tales and <br /> Tasteful Journey
                  </p>
                </div>
