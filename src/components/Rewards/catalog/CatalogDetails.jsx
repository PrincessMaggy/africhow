...
const CatalogDetailsPage = () => {
    ...
    const buttonClass = isButtonDisabled
        ? 'terms_button py-3 my-8  font-medium text-base cursor-pointer'
        : 'py-3 my-8  font-medium text-base checked_class bg-red-500';
    const handleGoBack = () => {
    ...
    return (
        <>
            ...
            <div className='item-details '>
                <div
                    className='header flex py-3 px-4 border-b border-#D9D9D9 cursor-pointer'
                ...
                <div className='body px-4 pt-10'>
                    ...
                    <p className='text-left font-bold text-sm my-4'>
                        {item.summary}
                    </p>
                    <p className='text-sm font-normal text-left mb-8'>
                        {item.description}
                    </p>
                    ...
                    <p className='text-left text-sm my-2'>
                        I hereby agree to the use of my points or ratings to
                        receiving the {item.name} medal
                    </p>
                    ...
                    <div className='text-container '>
                        <div className='message text-white p-3'>
                            ...
                            <p className='text-left'>
                                You need {pointsDifference} more points to
                                redeem this tier
                            </p>

                            <p
                                className='dismiss font-medium text-left mt-4'
                                onClick={() => {
                                    setShowModal(false);
                                }}
                            >
