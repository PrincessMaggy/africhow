    ...
    return (
        <div className='w-full min-h-full bg-opacity-25'>
            <div className='relative flex flex-col justify-center px-8'>
                ...
                <section className='section-banner bkground w-full rounded-2xl lg:w-60'>
                    <div className='py-3 px-5 font-bold text-left'>
                ...
                <section className='flex justify-center text-left w-full lg:'>
                    <div className=' w-full flex flex-col justify-center mb-28 pt-12'>
                    {
