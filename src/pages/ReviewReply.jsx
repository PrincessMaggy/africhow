    ...
    return (
        <>
            ...
            <div className='w-full p-4 h-20 relative bg-emerald-400 bg-opacity-10 flex items-center'>
                <img
                    className='w-12 h-12 left-0 ml-4 rounded-full'
                    src={Joshua}
                    alt='Joshua'
                />
                <div className='w-8 h-8 ml-4 md:ml-64 mt-1 absolute' />
                <div className="ml-4 md:ml-16 text-neutral-900 text-lg font-medium font-['Manrope'] tracking-tight">
                    Good afternoon Joshua
                </div>
                <div className="ml-4 md:ml-16 text-neutral-900 text-base font-medium font-['Manrope'] tracking-tight">
                    You’ve received 20 reviews
                </div>
            </div>
            ...
            <div className='left-[0] p-4 top-[150px] absolute flex-col justify-start items-start gap-4 inline-flex'>
                ...
                <div className='Btn px-4 py-1 bg-emerald-400 justify-center items-center gap-2.5 inline-flex'>
                    <div
                        className="Reply text-center text-white text-base font-medium font-['Manrope'] tracking-tight"
                        onClick={handleReply}
                    >
                        Reply
                    </div>
                ...
                <div className='flex-col justify-start items-start gap-3 flex'>
                    ...
                    <div className='w-full md:w-96'>
                        ...
                        <div className='Btn px-4 py-1 bg-emerald-800 justify-center items-center gap-2.5 inline-flex'>
                            <div
                                className=" text-center text-white text-base font-medium font-['Manrope'] tracking-tight"
                        ...
                        <div className='Btn-delete px-4 py-1  justify-center items-center gap-2.5 inline-flex'>
                            <div
                                className="text-center text-red-800 text-base font-medium font-['Manrope'] tracking-tight"
